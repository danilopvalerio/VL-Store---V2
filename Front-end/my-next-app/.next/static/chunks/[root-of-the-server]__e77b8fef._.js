...
const ProductDetail = ()=>{
    ...
    const handleVariationBlur = async (index)=>{
        ...
        if (variation.id_variacao) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].patch(`http://localhost:9700/api/produtos/variacoes/${variation.id_variacao}`, {
                    valor: valorNumerico
                }, {
                    headers: getAuthHeaders()
                });
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`http://localhost:9700/api/produtos/referencia/${productData.referencia}/loja/${productData.id_loja}/variacoes`, {
    ...
    const handleVariationChange = (index, e)=>{
        ...
        if (name !== "valor") {
            ...
            if (variation.id_variacao) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].patch(url, {
                    [name]: variation[name]
                }, {
                    headers: getAuthHeaders()
                }).catch((err)=>{
    ...
    const removeVariation = async (index)=>{
        ...
        if (variation.id_variacao) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:9700/api/produtos/variacoes/${variation.id_variacao}`, {
                    headers: getAuthHeaders()
                });
            } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e77b8fef._.js.map