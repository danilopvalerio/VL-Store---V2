...
const ProductPage = ()=>{
    _s();
    const [produtos, setProdutos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const handleSearch = async (page = 1)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:9700/api/produtos/loja/${idLoja}/busca/${encodeURIComponent(searchTerm)}?page=${page}`, {
                headers: {
                    Authorization: `Bearer ${jwtToken}`
                }
            });
    ...
    const fetchProducts = async (page)=>{
        ...
        try {
            const parsedData = JSON.parse(userData);
            const idLoja = parsedData.id_loja;
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:9700/api/produtos/loja/${idLoja}/paginado?page=${page}&limit=${LIMIT}`, {
                headers: {
                    Authorization: `Bearer ${jwtToken}`
                },
                timeout: 2000
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: produtos.length > 0 ? produtos.map((produto, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ui$2f$components$2f$products$2f$ProductCardComponent$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                                    product: produto
                                }, index, false, {
                                    fileName: "[project]/src/pages/productsPage.tsx",
                                    lineNumber: 178,
...
_s(ProductPage, "bwyzXIPx8NYPM8H9KHkSqORRxXg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c1e88a7b._.js.map