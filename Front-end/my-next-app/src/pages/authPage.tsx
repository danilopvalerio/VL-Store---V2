...
const AuthPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`d-flex justify-content-between flex-column ${styles.container}`}
      >
        ...
        <main className={`mx-auto w-75  ${styles.loginBlock}`}>
          <div className={`shadow  ${styles.column}`}>
            <div
              className={`text-white text-center p-4 ${styles.welcomePanel}`}
            >
              <h4>Bem-vindo!</h4>
            ...
            <div className={`p-4 ${styles.formPanel}`}>
              ...
              <form onSubmit={handleLogin}>
                ...
                <Link className="w-100 text-center mt-3" href="/initialPage">
