...
export default class VendaController {
	...
	async createVenda(req: Request, res: Response) {
		...
		try {
			...
			// verificar se o funcionário existe e se está vinculado a uma loja
			...
			// Processar itens e calcular subtotal
			let subtotal = 0;
